...
function menuMaker (menuArray){
  ...
  // holder.appendChild(student);
  // holder.appendChild(faculty);
  // holder.appendChild(whatsNew);
  // holder.appendChild(techTrends);
...
console.log(header)
//   menuItems.forEach((menuDataObj) =>{
//    const panel = menuMaker(menuDataObj);
